var SharepointListItemCrud = function () {
  this.create = function (listName, data, options) {
    var options = options || {}
  ...
  this.read = function (listName, options) {
    var options = options || {}
  ...
  this.update = function (listName, id, data, options) {
    var options = options || {}
    var successCallback = options.successCallback || function(){}
    var errorCallback = options.errorCallback || function(err){console.log(JSON.stringify(err));}
    $.ajax({
  ...
  this.delete = function (listName, id, options) {
    var options = options || {}
    var successCallback = options.successCallback || function(){}
    var errorCallback = options.errorCallback || function(err){console.log(JSON.stringify(err));}
    $.ajax({
